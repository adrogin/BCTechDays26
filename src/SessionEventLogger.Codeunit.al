codeunit 50703 "Session Event Logger"
{
    ...
    var
        ...
        UpdateInLoopMessageLbl: Label 'Modifying records from %1 to %2 in a loop.', Locked = true;
    begin
        case SessionParameters.Action of
            ...
            "Session Action"::Modify:
                exit(StrSubstNo(UpdateOneMessageLbl, SessionParameters."First Record No."));
            "Session Action"::ModifyInLoop:
                exit(StrSubstNo(UpdateInLoopMessageLbl, SessionParameters."First Record No.", SessionParameters."Last Record No."));
        end;
    end;
